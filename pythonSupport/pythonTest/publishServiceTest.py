...
# Takes a URL and a dictionary and sends the request, returns the JSON
    ...
    print "published time："+str(time_passed)

    print "begin to request services:"
    t_begin2=datetime.now()
    url="http://192.168.220.80:6080/arcgis/rest/services/Untitled/MapServer?f=json"
