...
def addItem(username, folder, description, data, portalUrl, token,
    ...
    title= json.loads(description)['title'].encode('utf8')
    print chardet.detect(data)
    data2=data.decode("ascii").encode('utf8')
    print chardet.detect(data2)

    parameters = urllib.urlencode({'item': title,
                                   'text': data2,
                                   'overwrite': 'false',
...
if __name__ == '__main__':
    ...
    sourcePortal = "https://server122.esrichina.com/arcgis"
    sourceAdmin ="arcgis"
    sourcePassword = "Super123"
    query = "owner:arcgis"
    destPortal ="https://jmb.portal.com/arcgis"
    destAdmin="arcgis"
    destPassword = "Super123"
    owner = "arcgis"
    Destfolder ="testCopy"
